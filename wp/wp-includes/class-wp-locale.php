...
class WP_Locale {
     ...
     *@since 2.1.0
     */
    public function get_weekday_initial(string $weekday_name): string {
     ...
     *@since 2.1.0
     */
    public function get_weekday_abbrev(string $weekday_name): string {
     ...
     *
     * @param int|string $month_number '01' through '12'
     *
     * @return string translated full month name
     *
     *@since 2.1.0
     */
    public function get_month(int|string $month_number): string {
    ...
    public function get_word_count_type() {
         ...
         */
        $word_count_type = null === $this->word_count_type ? _x('words', 'Word count type. Do not translate!') : $this->word_count_type;
