...
final class WP_Block_Type_Registry {
     ...
     * @var WP_Block_Type[]
     */
    private array $registered_block_types = [];
     ...
     *
     * @return false|WP_Block_Type the registered block type on success, or false on failure
     */
     ...
     *
     * @return false|WP_Block_Type the unregistered block type on success, or false on failure
     */
     ...
     *
     * @return null|WP_Block_Type the registered block type, or null if it is not registered
     */
    ...
    public static function get_instance() {
        if (!self::$instance instanceof \WP_Block_Type_Registry) {
