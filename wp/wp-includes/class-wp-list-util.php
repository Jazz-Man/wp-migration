...
class WP_List_Util {
     ...
     * @param null|int|string $index_key Optional. Field from the element to use as keys for the new array.
     *                                   Default null.
     *
     ...
     *@since 4.7.0
     */
    public function sort(array|string $orderby = [], string $order = 'ASC', bool $preserve_keys = false): array {
        if (empty($orderby)) {
            return $this->output;
        }
     ...
     *
     * @param array|object $a one object to compare
     * @param array|object $b the other object to compare
     *
