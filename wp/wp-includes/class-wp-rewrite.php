		...
		for ( $j = 0; $j < $num_dirs; ++$j ) {
			...
			if ( $num_toks ) {
				...
				if ( str_contains( $struct, '%postname%' )
				     ...
				     || ( str_contains( $struct, '%year%' ) && str_contains( $struct, '%monthnum%' ) && str_contains( $struct, '%day%' ) && str_contains( $struct, '%hour%' ) && str_contains( $struct,
							'%minute%' ) && str_contains( $struct, '%second%' ) )
						) {
					$post = true;
