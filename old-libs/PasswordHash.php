...
class PasswordHash {
    ...
    public function __construct(int $iteration_count_log2, public bool $portable_hashes) {
    ...
    public function get_random_bytes(int $count): bool|string {
        $output = '';
    ...
    public function encode64($input, int $count): string {
        $output = '';
        $i = 0;
    ...
    public function HashPassword(string $password): string {
        ...
        if (CRYPT_BLOWFISH === 1 && !$this->portable_hashes) {
            ...
            $hash = crypt($password, (string) $this->gensalt_blowfish($random));
